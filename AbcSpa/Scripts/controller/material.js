...
angular.module("abcadmin")
    ...
    [
        ...
        function($scope, $route, $location, $http, $cookies, $controller) {
            ...
            $scope.mainFunction(
                "icon mif-cog", "Name",
                "/material/refreshlist", filters,
                "/material/saveactivestatus", setActivationObjects,
                "/material/savematerial", saveObject,
                editElement,
				"material"
                );
            ...
            $scope.boxHeaderTitleActive = "Materiales activos";
            $scope.boxHeaderTitleDeactive = "Materiales de baja";
    ...
    [
        ...
        function($scope, $routeParams, $location, $http, $controller, securityFact, notification, ngDialog) {
            ...
            $scope.dialogTitle = $scope.ngDialogData.dData.Id == undefined ?
                "Nuevo material" : "Editar material " + $scope.ngDialogData.dData.Name;
            ...
            $scope.acceptDialog = function () {
                ...
                if ($scope.ngDialogData.dData.Name === undefined) {
                    notification.error({
                        message: "Nombre del material indefinido",
                        delay: errorDelay
                    });
                    error = true;
                }
