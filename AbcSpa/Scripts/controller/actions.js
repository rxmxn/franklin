...
angular.module("abcadmin")
    ...
    [
        ...
        function($scope, $route, $location, $http, $cookies, $controller) {
            ...
            $scope.mainFunction(
                "icon mif-school", "Name",
                "/actions/refreshlist", filters,
                "/actions/saveactivestatus", setActivationObjects,
                "/actions/saveactions", saveObject,
                editElement,
				"ack"
                );
            ...
            $scope.panels = [
                ...
                {
                    index: 1,
                    name: 'Tabla Tipos de Reconocimientos',
                    state: true,
                    size: 9
                }
            ];
    ...
    [
        ...
        function($scope, $routeParams, $location, $http, $controller, securityFact, notification, ngDialog) {
            ...
            $scope.dialogTitle = $scope.ngDialogData.dData.Id == undefined ?
                "Nuevo Tipo de Reconocimiento" : "Editar Tipo de Reconocimiento " + $scope.ngDialogData.dData.Name;
            ...
            $scope.acceptDialog = function () {
                ...
                if ($scope.ngDialogData.dData.Name === undefined) {
                    notification.error({
                    	message: "Nombre del tipo de reconocimiento indefinido",
                        delay: errorDelay
                    });
                    error = true;
                }
