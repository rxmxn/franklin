    ...
    [
        ...
        function ($scope, $route, $location, $http, $cookies, $controller) {
            ...
            var saveObject = function (promise) {
                ...
                return { measureunit: measureunitObj }
            }

            var editElement = function (element) {
                return {
                    template: "editDialog",
                    controller: "NewMeasureUnitController",
            ...
            $scope.mainFunction(
                "icon mif-multitrack-audio", "Name",
                "/measureunit/refreshlist", filters,
                "/measureunit/saveactivestatus", setActivationObjects,
                "/measureunit/savemeasureunit", saveObject,
                editElement,
				"measureunits"
                );

            // MeasureUnit specifics
            $scope.SearchGeneral = true;
            $scope.FilterActive = true;
            //$scope.boxHeaderTitleActive = "Unidades de Medida activas";
            //$scope.boxHeaderTitleDeactive = "Unidades de Medida de baja";
    ...
    [
        ...
        function ($scope, $routeParams, $location, $http, $controller, securityFact, notification, ngDialog) {
            ...
            $scope.dialogTitle = $scope.ngDialogData.dData.Id == undefined ?
                "Nueva unidad de medida" : "Editar unidad de medida " + $scope.ngDialogData.dData.Name;
            ...
            $scope.acceptDialog = function () {
                ...
                if ($scope.ngDialogData.dData.Name === undefined) {
                    notification.error({
                        message: "Nombre del unidad de medida indefinida",
                        delay: errorDelay
                    });
                    error = true;
                }
