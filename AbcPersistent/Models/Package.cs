...
namespace AbcPersistent.Models
{
    ...
    public class Norm
    {
        ...
        public DateTime? FechaEntVigor { get; set; }
        ...
        public dynamic ToJson()
        {
            return new
            {
                ...
                Description,
                Alcance,
                FechaEntVigor=FechaEntVigor?.ToString("dd/MM/yyyy") ?? "",
                FechaCambioStatus=FechaCambioStatus?.ToString("dd/MM/yyyy") ?? "",
                Estado = Estado?.ToJson(),
                Matrixes=Matrixes?.Where(m=>m.Active).Select(m=>m.ToJson())
            };
        }
    ...
    public class Status
    {
        ...
        public dynamic ToJson()
        {
            return new {Id, Tipo, Description, Active};
        }
    }
